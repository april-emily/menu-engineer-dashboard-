...
## Overview
The Menu Engineer is an interactive Business Intelligence tool designed to help hospitality managers optimise their menu profitability. Drawing on the classic "Menu Engineering" matrix, this dashboard visualises the relationship between Item Popularity (Volume) and Profitability (Contribution Margin). It automatically categorises menu items into four strategic segments to guide decision-making:
...
generate_data.py: A Python script to generate realistic dummy data for testing.

menu_data.csv: Pre-generated sample data (created by the script above).

requirements.txt: List of dependencies required to run the app.

## How to Run Locally
Clone this repository:
git clone [https://github.com/april-emily/menu-engineer-dashboard-.git](https://github.com/april-emily/menu-engineer-dashboard-.git) cd menu-engineer-dashboard-
...
Sales_Price: Price sold to customer (Number)

Cost_Price: Cost of goods sold/COGS (Number)

Number_Sold: Quantity sold in a given period (Number)
